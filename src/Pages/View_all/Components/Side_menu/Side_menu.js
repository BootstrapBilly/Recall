    ...
    return (
        ...
        <div className={classes.container}>
            ...
            <div className={classes.icon_container} onClick={()=> dispatch(collapse_all())}>
                ...
                <span className={classes.icon_text} style={{color:colours.primary}}>Close All</span>
            ...
            <div className={classes.icon_container} onClick={()=> set_redirect(true)}>
                ...
                <span className={classes.icon_text} style={{color:colours.primary, marginTop:"5px"}}>Add new</span>
