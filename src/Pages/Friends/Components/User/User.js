...
export const User = props => {
    ...
    return (
        ...
        <React.Fragment>
            ...
            <div className={classes.container} onClick={() => props.add_friend || props.remove_access ? props.onClick(props.details) : handle_show_options()} style={{ marginTop: props.marginTop }} test_handle={props.details.username || props.details.user_details.username}>
