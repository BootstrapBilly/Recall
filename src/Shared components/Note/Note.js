            ...
            {props.re_arrange && <div className={classes.click_prevention_overlay}></div>}
                ...
                <div className={classes.measuring_wrapper} ref={ref} >
                    ...
                    {expanded ?
                        ...
                        show_delete_confimation ?

                            <DeleteConfirmation

                                cancel_delete={() => set_show_delete_confirmation(false)}
                                title={show_delete_confimation}
                                note_id={note_id}
                                is_a_collection={is_a_collection}
                                example={props.example}
                                has_been_granted={has_been_granted}
                            ...
                            : <div className={classes.expanded_content}>
                                ...
                                {is_a_collection ?
                                    ...
                                    <Link to={{ pathname: props.example ? undefined : "/collection_detail", state: { id: props.details._id, title:props.details.title } }} style={{ textDecoration: "none", backgroundColor: colours.green }} className={classes.view_notes_button} >
                                ...
                                {has_been_granted && <SharedBy details={props.details} />}
                                ...
                                {props.selected || props.combine ? undefined :
                                    ...
                                    <Buttons
                                        ...
                                        has_been_granted={has_been_granted}
                                        handle_remove_access={() => set_show_delete_confirmation("Access")}
