...
import { expand_note, collapse_note } from "../../Store/Actions/1_handle_toggle_note_action"
...
export const Note = props => {
    ...
    const expanded_notes = useSelector(state => state.note_toggle.expanded_notes)//grab the array of expanded notes from the reducer
    ...
    const handle_cancel_click = () => {
        ...
        set_edit_mode(false)//set edit mode to false
                ...
                {expanded_notes.find(note => note === props.details._id) &&
                    ...
                    <div className={classes.expanded_content}>
                        ...
                        <Buttons
                            ...
                            handle_edit_click={() => set_edit_mode(!edit_mode)}
                            edit_mode={edit_mode}
