describe("@@@@@ SEARCH BOX TESTING @@@@@", () => {
    ...
    context("Check the functionality of it", () => {
        ...
        it("Backspace all the way to 'A' - 6 notes should be visible", () => {
        ...
        it("Clear the input then type 'no existo' - 0 notes should be visible", () => {

            cy.get('[test_handle="search_input"]').type("{backspace}no existo")
